...
function onCreate()
    ...
    Ground_0:setPosition(65.0, -100.0)
    ...
    Ground_1:setPosition(-41.0, -110.0)
    ...
    Ground_1:addVertex(32.0, 334.0)
    Ground_1:addVertex(77.0, 349.0)
    Ground_1:setPosition(-41.0, -180.0)
    Ground_1:setRotation(0.0)
    Ground_1:setName('Ground_1')
    Ground_1:setVisible(true)
    world:add(Ground_1)
    ...
    Ground_2:setPosition(-26.999994, -131.0)
